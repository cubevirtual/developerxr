...
const _settings = {
  // 3D model:
  //GLTFModelURL: 'https://cdn.jsdelivr.net/gh/cubevirtual/2m/demos/2MFace/demos/VTOGlasses/assets/models3D/glasses2.glb',

  // lighting:
  envmapURL: 'https://cdn.jsdelivr.net/gh/cubevirtual/2m/demos/2MFace/demos/earrings3D/assets/venice_sunset_512.hdr',
...
function start(){
  ...
  WebARRocksFaceEarrings3DHelper.init({
    NN: 'https://cdn.jsdelivr.net/gh/cubevirtual/2m/demos/2MFace/neuralNets/NN_EARS_4.json',
...
function load_GLTF(modelURL, isRight, isLeft){
  new THREE.GLTFLoader().load(modelURL, function(gltf){
    ...
    model.scale.multiplyScalar(1); // because the model is exported in meters. convert it to cm
